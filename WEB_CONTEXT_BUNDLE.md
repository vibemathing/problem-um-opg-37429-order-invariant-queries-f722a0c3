...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37429-order-invariant-queries-f722a0c3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37429"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37429-order-invariant-queries-f722a0c3-v1",
      "problem_contract_sha256": "9f7ed8aba39d73ce54a9858daa288308e11589b5188a0fd8ebc05f69b3921f13",
      "problem_id": "problem:um-opg-37429-order-invariant-queries-f722a0c3",
      "route_id": "route:um-opg-37429-order-invariant-queries-f722a0c3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37429-order-invariant-queries-f722a0c3-source-fidelity-01",
      "graph_id": "graph:um-opg-37429-order-invariant-queries-f722a0c3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37429-order-invariant-queries-f722a0c3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37429-order-invariant-queries-f722a0c3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Question - Does ${<}\\text{-invariant\\:FO} = \\text{FO}$ hold over graphs of bounded tree-width? - Is ${<}\\text{-invariant\\:FO}$ included in $\\text{MSO}$ over graphs? - Does ${<}\\text{-invariant\\:FO}$ have a 0-1 law? - Are properties of ${<}\\text{-invariant\\:FO}$ Hanf-local? - Is there a logic (with an effective syntax) that captures ${<}\\text{-invariant\\:FO}$?"
          },
          "statement_sha256": "158b8e1c4f98623703c2f742ed6440d4eeeb48c5f98428bba94eccb40dfcc2a3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37429-order-invariant-queries-f722a0c3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37429-order-invariant-queries-f722a0c3-root",
      "route_id": "route:um-opg-37429-order-invariant-queries-f722a0c3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37429-d5f99c9668da",
        "url": "https://www.unsolvedmath.com/problems/OPG-37429"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
